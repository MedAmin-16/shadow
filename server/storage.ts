import { type User, type InsertUser, type Scan, type InsertScan, type Project, type InsertProject, type Activity, type Report, type UserSettings, type UserCredits, type PlanLevel, type ExploitApprovalRequest } from "@shared/schema";
